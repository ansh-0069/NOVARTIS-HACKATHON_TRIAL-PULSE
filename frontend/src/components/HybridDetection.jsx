...
function HybridDetection({ onConfigChange }) {
    ...
    const toggleDetector = (detector) => {
        ...
        // Rebuild the method string from the new detector state
        ...
        setDetectionConfig(prev => ({
            ...
            // Always derive from the new toggle state — never rely on prev value
            // which could get stuck at false if GC-MS was toggled off then back on.
            gc_ms_detected: newDetectors.GC_MS === true
        }));
    };
